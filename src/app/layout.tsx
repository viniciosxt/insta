...
export const metadata: Metadata = {
   title: 'Mesa — a rede social do bar',
   description: 'Encontre pessoas, momentos e partidas no bar em que você está.',
   icons: {
      icon: '/favicon.svg',
   },
};
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
   return (
      <>
         ...
         <html lang="pt-BR" className={`${chivo.variable} ${darkClass}`}>
